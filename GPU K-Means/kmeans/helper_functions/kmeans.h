...
void kmeans_gpu(float *objects, int numCoords, int numObjs, int numClusters, float threshold, long loop_threshold,
                int *membership, float *clusters, int block_size);
